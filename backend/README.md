...
| `MONGODB_URI` | MongoDB connection string | `mongodb://localhost:27017/skillfoundry` |
...
#### Heroku
```bash
heroku create skillfoundry-api
...
npm install -g pm2
pm2 start dist/server.js --name "skillfoundry-api"
pm2 startup
pm2 save
```
