...
export const submitQuiz = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    ...
    // Update mastery score (simplified - could be more sophisticated)
    // For now, we'll assume the quiz is for a specific topic
    // In a real implementation, you'd link lessons to topics properly
