...
import { AuthResponse, Curriculum, Dashboard, Lesson, Quiz, QuizResult, Resource, Project } from '../types';
...
export const lessonsAPI = {
  ...
  generateLesson: (subtopicId: string, curriculumId: string): Promise<{ lesson: Lesson }> =>
    api.post(`/lessons/subtopic/${subtopicId}/${curriculumId}`).then(res => res.data),
