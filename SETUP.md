# SkillFoundry Setup Guide

## Prerequisites

Before setting up SkillFoundry, ensure you have:
...
```env
PORT=3000
MONGODB_URI=mongodb://localhost:27017/skillfoundry  # or your Atlas URI
...
1. **Backend Health Check**:
   ...
   ```
   Should return: `{"status":"OK","message":"SkillFoundry API is running"}`

2. **Frontend Access**:
   - Open http://localhost:3001
   - You should see the SkillFoundry login page
...
Your SkillFoundry application should now be running successfully!